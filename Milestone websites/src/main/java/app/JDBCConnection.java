...
public class JDBCConnection {
    ...
    public ArrayList<Movie> getTypeMovies() {
        ArrayList<Movie> moviesType = new ArrayList<>();
    ...
    public ArrayList<Movie> getDirector() {
        ArrayList<Movie> directorList = new ArrayList<>();
        ...
        try {
            ...
            // The Query
            String query = "SELECT DISTINCT DIRNAME FROM DIRECTOR NATURAL JOIN MOVIE;";
            System.out.println(query);
            ...
            while (results.next()) {
                ...
                movie.director= results.getString("dirname");

                directorList.add(movie);
            }
